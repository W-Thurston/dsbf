<template>
  <div class="relationships-tab">
    ...
    <!-- Left: column browser (identical pattern to DistributionsTab) -->
    ...
    <div v-if="primaryColumn" class="detail-pane">
      ...
      <h2 class="col-heading">
        ...
        <span class="col-heading-badge" :class="`intent-${primaryIntent}`">{{ primaryIntent }}</span>
      </h2>
      ...
      <div v-else class="select-prompt">
        Click a row in the Associations panel to plot the relationship.
      </div>
    </div>
    ...
    <div v-else class="empty-state card">
      ...
      <p>Select a column from the browser to explore its relationships.</p>
    </div>
...
import CollinearityCard from '../../components/relationships/CollinearityCard.vue'
...
// collinearity (high VIF) or data leakage with another column.
